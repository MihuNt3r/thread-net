...
namespace Thread_.NET.BLL.Services
{
    public sealed class LikeService : BaseService
    {
        ...
        {
            var likes = _context.PostReactions.Where(x => 
                x.UserId == reaction.UserId && x.PostId == reaction.EntityId && reaction.IsLike);
        ...
        {
            var dislikes = _context.PostReactions.Where(x =>
                x.UserId == reaction.UserId && x.PostId == reaction.EntityId && !reaction.IsLike);
